...
class DeliveryDates extends StatefulWidget {
  final String name,_id;
  DeliveryDates(this.name,this._id);

  @override
  _DeliveryDates createState() => _DeliveryDates();
}


class _DeliveryDates extends State<DeliveryDates> {
