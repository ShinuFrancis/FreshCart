...
class _OrderApproved extends State< OrderApproved>{
  ...
  void OrderView () async {
    ...
    var url = Prefmanager.baseurl+'/Purchase/groupedmyorders?status='+'Approved''&count='+count.toString()+'&page='+page.toString();
                            ...
                            return
                              Card(
                                ...
                                child: InkWell(
                                  onTap: ()async{
                                    bool pro=await
                                    Navigator.push(context, new MaterialPageRoute(builder: (context) => OrderMap(order[index])));
                                    //order.clear();
                                    // page =1;
                                    //OrderView();
